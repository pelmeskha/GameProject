...
SimpleTank(x::Real, y::Real, vx::Real, vy::Real, angle::Real) = SimpleTank(
    Observable(x),
    Observable(y),
    Observable(vx),
    Observable(vy),
...
SimpleTank(x::Observable{Float64}, y::Observable{Float64}) =
    SimpleTank(x, y, Observable(0.0), Observable(0.0), Observable(0.0))
